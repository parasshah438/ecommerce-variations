...
<head>
    ...
    <style>
        ...
        *::-webkit-scrollbar-thumb {
        ...
        .sidebar-container.collapsed .sidebar-header .brand-text {
            display: none;
        }
        ...
        .sidebar-container.collapsed .nav-link .nav-text {
            display: none;
        }
        ...
        .sidebar-container.collapsed .search-icon,
        .sidebar-container.collapsed .search-clear {
            display: none;
        }

        .sidebar-container.collapsed .search-results {
            left: var(--sidebar-collapsed-width);
            right: auto;
            min-width: 300px;
        }

        /* Filter highlighting for navigation items */
        .nav-section.filtered {
        ...
        .search-active .nav-section-title {
