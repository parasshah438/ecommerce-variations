    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 text-gray-800 mb-0">Edit Slider</h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Slider Details</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.sliders.update', $slider) }}" enctype="multipart/form-data">
                        ...
                        @if($slider->image)
                            <div class="mb-4">
                                ...
                                <div class="position-relative">
                                    <img src="{{ $slider->getThumbnailUrl(600) }}" 
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">
                                New Slider Image <span class="text-muted">(Optional)</span>
                            </label>
                            <input type="file" 
                            ...
                            <div class="form-text">
                                <i class="bi bi-info-circle"></i> 
                                Upload new image (JPEG, PNG, GIF, WebP). Max 5MB. 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-success w-100">
                                    <i class="bi bi-check-lg me-2"></i>Update Slider
                                </button>
                            </div>
                            <div class="col-md-6">
            ...
            <div class="card shadow mt-4 border-danger">
                ...
                <div class="card-body">
                    <p class="text-muted">Once you delete this slider, there is no going back. Please be certain.</p>
                    <form action="{{ route('admin.sliders.destroy', $slider) }}" 
                          method="POST" 
                          onsubmit="return confirm('Are you absolutely sure you want to delete this slider? This action cannot be undone.')">
                        @csrf
                        @method('DELETE')
