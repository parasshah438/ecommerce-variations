    ...
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 text-gray-800">Edit Attribute Value: {{ $attributeValue->value }}</h1>
                    ...
                    <form method="POST" action="{{ route('admin.attribute-values.update', $attributeValue) }}">
                        ...
                        <div class="form-group" id="colorGroup" style="display: none;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="hex_color" 
                                       name="hex_color" 
                                       value="{{ old('hex_color', $attributeValue->hex_color) }}" 
                                       placeholder="#FF0000"
                                       pattern="^#[0-9A-Fa-f]{6}$">
                            </div>
                            @error('hex_color')
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" 
                                       ...
                                       name="is_default" 
                                       value="1"
                                       {{ old('is_default', $attributeValue->is_default) ? 'checked' : '' }}>
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Attribute Value
                            </button>
