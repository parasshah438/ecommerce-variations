            ...
            <div class="card-body d-flex flex-column p-3">
                ...
                <div class="product-price mb-3">
                    @php
                        ...
                        $activeSale = method_exists($product, 'getActiveSale') ? $product->getActiveSale() : null;
                        $salePrice = $activeSale && method_exists($product, 'getBestSalePrice') ? $product->getBestSalePrice() : null;
                        $discountPercentage = method_exists($product, 'getDiscountPercentage') ? $product->getDiscountPercentage() : 0;
...
@empty
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
        <div class="card product-card h-100 shadow-sm border-0">
            <div class="product-image-container position-relative d-flex flex-column align-items-center justify-content-center" style="height: 300px;">
                <i class="bi bi-search text-muted" style="font-size: 3rem;"></i>
                <h4 class="mt-3 text-muted">No products found</h4>
                @if(!empty($searchMeta['query']))
                    <p class="text-muted">We couldn't find any products matching "{{ $searchMeta['query'] }}"</p>
                    ...
                    <div class="mt-4">
                        <a href="{{ route('search.index') }}" class="btn btn-primary me-2">
                            Browse All Products
                        </a>
