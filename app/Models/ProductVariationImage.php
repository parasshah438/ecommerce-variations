...
class ProductVariationImage extends Model
{
    ...
    public function getImageUrlAttribute()
    {
        ...
        return asset('images/variation-placeholder.jpg');
    }
    ...
    {
        if (!$this->path) {
            return '<img src="' . asset('images/variation-placeholder.jpg') . '" alt="' . htmlspecialchars($alt ?: $this->alt) . '" class="' . $class . '">';
        }
    ...
    public function deleteImageFiles()
    {
        ...
        try {
            ...
            // Delete thumbnails (variations: 150, 300)
            ...
            \Log::warning('Failed to delete some variation image files: ' . $e->getMessage(), [
